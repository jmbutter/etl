...
module ETL::Redshift
  class IDAugmenterFactory <::ETL::Transform::IDAugmenterFactory
    def initialize(client, table_name, natural_keys, filter_part = nil)
      ...
      super(surrogate_key, natural_keys, r)
    end
  end
end
